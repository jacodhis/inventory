...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{asset('temp/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="#">jacodhis</a>.</strong>
    All rights reserved.
